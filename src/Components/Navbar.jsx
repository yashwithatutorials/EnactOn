...
<Container sx={{display:{xs:"none",sm:"none",md:"block",lg:"block"},marginTop:"40px"}}>
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 ">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Your Company</span>
            <Box component='img' src='../../src/assets/enact.png' sx={{width:{md:"300px",lg:"300px"},marginLeft:{lg:"-70px",md:"-45px"},marginTop:{md:"-25px"}}}/>
          </a>
        </div>
...
<a href="#">AWS</a>
  ...
  <div className="dropdown-content "  style={{ width: "1030px", marginLeft: "-350px" }}>
  <div style={{float:"left"}}>
...
<Button  sx={{marginLeft:{md:"13px",lg:"38px"},color:"white",borderRadius:"11px",width:"100px",height:"45px",marginRight:{md:"-50px"}}} className='bg-gradient-to-r from-emerald-500 to-orange-500  '>Let's Talk</Button>
      ...
      <Container sx={{display:{xs:"block",sm:"block",md:"none",lg:"none"},marginTop:"30px"}}>
        <nav   >
        <div className="flex justify-between" >
          <a href="#" >
            <Box component='img' src='../../src/assets/enact.png' sx={{width:{xs:"180px",sm:"180px"},marginLeft:{xs:"-10px"},marginTop:{xs:"20px",sm:"20px"},display:{xs:"block",sm:"block",md:"none",lg:"none"}}}/>
          </a>
